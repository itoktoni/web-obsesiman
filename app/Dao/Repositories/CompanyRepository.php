...
class CompanyRepository extends Company implements MasterInterface
{
    public function dataRepository()
    {
        $list = Helper::dataColumn($this->datatable, $this->getKeyName());
        $area = new AreaRepository();
        return $this->select($list)->leftJoin($area->getTable(),$area->getKeyName(), 'company_contact_rajaongkir_area_id');
    }
