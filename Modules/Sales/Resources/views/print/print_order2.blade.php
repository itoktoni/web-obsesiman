...
<head>
    ...
    *:after {
    ...
    <title>Quotation_{{ $master->sales_order_id ?? '' }}</title>
</head>
            ...
            <div id="box">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $master->sales_order_date_quotation->format('d F Y') ?? '' }}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <table cellpadding="" 5 cellspacing="0" width="100%">
                ...
                <tr class="item">
                    ...
                    <td class="product" colspan="4">
                        ...
                        <p>
                            <strong>Spec : </strong>{!! $item->sales_order_detail_item_product_description ?? '' !!}
                        </p>
                        @if($item->sales_order_detail_discount_percent)
                        <span>
                            Discount ( {{ Helper::createRupiah($item->sales_order_detail_discount_percent) }}% ) :
                            {{ $item->sales_order_detail_discount_name }}
                        </span>
                        @endif
                    </td>
                    <td class="price">
                    ...
                    <td class="total">
                        @if($item->sales_order_detail_discount_percent)
                        <span>
                            Disc : {{ $item->sales_order_detail_discount_percent }}%
                        </span>
                        <span>
                            - {{ Helper::createRupiah($item->sales_order_detail_discount_value) }}
                        </span>
                        @endif
                ...
                <tr class="total_product">
                    ...
                    <td class="total">
                        {{ Helper::createRupiah($detail->sum('sales_order_detail_total')) ?? '' }}
                    </td>
                </tr>
                ...
                <tr class="total_discount">
                    ...
                    <td class="total">
                        {{ Helper::createRupiah($master->sales_order_tax_value) ?? '' }}
                    </td>
                </tr>
                @endif
        ...
        <table id="paraf">
            ...
            <tr class="content">
                ...
                <td class="description">
                    ...
                    {!! $master->sales_order_term_product !!}
                </td>
            </tr>
        </table>
</body>
