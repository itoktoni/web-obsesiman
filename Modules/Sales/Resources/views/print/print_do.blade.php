    ...
    <div id='page'>
        <div>
            ...
            <div id="box">
                <h1>
                    <span>
                        NO. {{ $master->sales_delivery_id ?? '' }}
                    </span>
                </h1>
                <h2>
                    Order Date : {{ $master->sales_delivery_date_order->format('d F Y') }}
                </h2>
                <table>
                    <tr>
                        <td class="head">
        ...
        <div id="address">
            <h4>
                {{ $master->sales_delivery_from_address ?? '' }}
            </h4>
            <p>
            </p>
        </div>
        <div id="container">
            <table cellpadding="" cellspacing="0" width="100%">
                ...
                <tr class="contact">
                    <td colspan='3'>
                        ...
                        <p>
                            {{ $master->sales_delivery_to_address ?? '' }}
                        </p>
                        
                        <p class="person">
                            {{ $master->sales_delivery_to_person ?? '' }} ( {{ $master->sales_delivery_to_phone ?? '' }}
                            )
                        </p>
                        <p>
                            email : {{ $master->sales_delivery_to_email ?? '' }}
                        </p>
                        {{ $master->company->company_description ? '<p>'.$master->company->company_description.'</p>' : '' }}
                    </td>
                    <td colspan='3' class="message">
                        {!! $master->sales_delivery_notes_external ?? '' !!}
                    </td>
                </tr>
            ...
            <table width="100%" border="0" style="margin-top:10px;width:100% !important;font-size:10px;margin-bottom:-50px">
                <tr>
                    <td style="width: 50%;" align="center">Delivered By (Sign & Stamp)</td>
                    <td align="center">Received By (Sign & Stamp)</td>
                </tr>
                <tr>
                    <td>
                        <br>
