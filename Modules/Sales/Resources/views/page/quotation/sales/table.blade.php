    ...
    <tbody class="markup">
        ...
        <tr>
            ...
            <td data-title="Product">
                ...
                <textarea placeholder="notes" tabindex="{{ $loop->iteration }}5" class="form-control temp_notes simple" name="detail[{{ $loop->index }}][temp_notes]">{{ $item['temp_notes'] ?? $item->sales_quotation_detail_item_product_description }}</textarea>
            </td>
    ...
    <tbody>
        <tr>
            ...
            <td data-title="" class="text-right">
                {!! Form::text('sales_quotation_sum_product', null, ['id' => 'before_discount',
        ...
        <tr style="margin-bottom: 20px;">
            ...
            <td data-title="Description" class="text-left col-md-4">
                {!! Form::textarea('sales_quotation_discount_name', null, ['id' => 'grand_discount_description', 'class' =>
                'form-control', 'rows' => 2, 'tabindex' => 500]) !!}
            </td>
            <td data-title="Value" class="text-right col-md-1">
                {!! Form::text('sales_quotation_discount_percent', null, ['id' => 'grand_discount_value', 'placeholder' =>
                'Dalam %' ,'class' => 'number form-control text-right', 'tabindex' => 501]) !!}
            </td>
            <td data-title="Price" class="text-right col-md-1">
                {!! Form::text('sales_quotation_discount_value', null, ['id' => 'grand_discount_price',
                'readonly', 'class' => 'number form-control text-right', 'tabindex' => 502]) !!}
            </td>
            <td data-title="Total" class="text-right col-md-1">
                {!! Form::text('sales_quotation_sum_discount', null, ['id' => 'grand_discount_total',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
        </tr>
        <tr style="margin-bottom: 20px;">
            ...
            <td data-title="Description" class="text-left col-md-4">
                {{ Form::select('sales_quotation_tax_id', $tax, null, ['class'=> 'form-control', 'id' => 'grand_tax_id', 'tabindex' => 503]) }}
            </td>
            <td data-title="Value" class="text-right col-md-1">
                {!! Form::text('sales_quotation_tax_percent', null, ['id' => 'grand_tax_value', 'placeholder' => 'Dalam %'
                ,'class' => 'number form-control text-right', 'tabindex' => 504]) !!}
            </td>
            <td data-title="Price" class="text-right col-md-1">
                {!! Form::text('sales_quotation_tax_value', null, ['id' => 'grand_tax_price',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
            <td data-title="Total" class="text-right col-md-1">
                {!! Form::text('sales_quotation_sum_tax', null, ['id' => 'grand_tax_total',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
        </tr>
        <tr>
            ...
            <td data-title="" class="text-right">
                {!! Form::text('sales_quotation_sum_total', null, ['id' => 'grand_total',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
        </tr>
    </tbody>
