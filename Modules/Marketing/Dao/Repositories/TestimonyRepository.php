...
use Modules\Marketing\Dao\Models\Testimony;

class TestimonyRepository extends Testimony implements MasterInterface
{
    ...
    public static function boot()
    {
        ...
        parent::saving(function ($model) {
            ...
            $file = 'marketing_testimony_file';
            if (request()->has($file)) {
                $image = $model->marketing_testimony_image;
                if ($image) {
                ...
                $model->marketing_testimony_image = $name;
            }
        });
            ...
            if (request()->has('id')) {
                ...
                if ($data) {
                    foreach ($data as $value) {
                        Helper::removeImage($value->marketing_testimony_image, Helper::getTemplate(__CLASS__));
                    }
                }
            }
        });
