...
use Modules\Marketing\Dao\Models\Benefit;

class BenefitRepository extends Benefit implements MasterInterface
{
    ...
    public static function boot()
    {
        ...
        parent::saving(function ($model) {
            $file = 'marketing_benefit_file';
            if (request()->has($file)) {
                $image = $model->marketing_benefit_image;
                if ($image) {
                ...
                $model->marketing_benefit_image = $name;
            }
        });
            ...
            if (request()->has('id')) {
                ...
                if ($data) {
                    foreach ($data as $value) {
                        if ($value->marketing_benefit_image) {
                            Helper::removeImage($value->marketing_benefit_image, Helper::getTemplate(__CLASS__));
                        }
                    }
                }
            }
