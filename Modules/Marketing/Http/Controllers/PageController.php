...
class PageController extends Controller
{
    ...
    public function data(MasterService $service)
    {
        if (request()->isMethod('POST')) {
            ...
            $datatable = $service->setRaw(['marketing_page_image'])->datatable(self::$model);
            $datatable->editColumn('marketing_page_image', function ($select) {
                return Helper::createImage(Helper::getTemplate(__CLASS__) . '/thumbnail_' . $select->marketing_page_image);
            });
