...
<div class="form-group">
    ...
    {!! Form::label('name', 'Estimasi Hari', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has($form.'estimasi') ? 'has-error' : ''}}">
        {!! Form::text($form.'estimasi', null, ['class' => 'form-control']) !!}
        {!! $errors->first($form.'estimasi', '<p class="help-block">:message</p>') !!}
    </div>
