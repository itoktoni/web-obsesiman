        ...
        <div class="nano-content" style="padding:10px 10px 10px 10px;border:none;">
            <nav id="menu" style="border:none;" class="nav-main" role="navigation">
                <div id="right-group" class="list-group">
                    ...
                    <div id="linkMenu"
                        onclick="location.href = '{{ route('access_group',[$group->group_module_code]) }}';"
                        href="{{ route('access_group',[$group->group_module_code]) }}"
                        class="pointer linkRight list-group-item {{ (Session(Auth::User()->username.'_group_access') == $group->group_module_code ? 'active' : '') }}">
                    ...
                    <div id="reboot"
                        style="background-color: #d2312d;border:none;color: white;text-align: right;font-weight: bold;"
                        href="{{ route('reboot') }}" onclick="location.href ='{{ route('reboot') }}';"
                        class="list-group-item">REBOOT</div>
                    @endif
                </div>
            </nav>
        </div>
